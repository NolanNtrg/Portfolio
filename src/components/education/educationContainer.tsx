export function EducationContainer({
  ...
  return (
    <div
      className={`ml-12 mr-12 mb-12 md:flex md:m-5 items-center ${index % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}
    >
      <div className="bg-gray-900 border  rounded-lg overflow-hidden border-green-400 hover:shadow-xl hover:shadow-green-500/10 md:w-[45vw]">
